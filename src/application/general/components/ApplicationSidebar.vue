<template>
  <div class="flex flex-col justify-between items-center z-10 w-16 overflow-auto bg-white border-r border-greyone">
    ...
    <div class="w-full align-center content-center items-center align-middle hover:bg-greyone">
      <a @click="this.createNewProjectWindowActive = !this.createNewProjectWindowActive" class="flex items-center justify-center cursor-pointer py-3 rounded border border-white bg-white hover:bg-greyone text-dark hover:text-one">
        <svg class="w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="7" cy="7" r="4"></circle><circle cx="17" cy="7" r="4" opacity=".35"></circle><circle cx="17" cy="17" r="4"></circle><circle cx="7" cy="17" r="4" opacity=".35"></circle></svg>
      </a>
    </div>
  </div>
