<template>
  <div class="flex flex-col items-center w-16 pb-4 overflow-auto bg-white border-r border-greyone">
    ...
    <a @click="this.createNewProjectWindowActive = !this.createNewProjectWindowActive" class="flex items-center justify-center cursor-pointer flex-shrink-0 w-10 h-10 mt-4 rounded border border-white bg-white hover:bg-greyone text-dark hover:text-one">
