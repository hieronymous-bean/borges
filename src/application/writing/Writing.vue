  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col flex-grow">
      <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
        <h1 class="text-2xl font-black">{{this.$route.meta.title}}</h1>
        <button class="flex items-center justify-center h-10 px-2 ml-auto text-sm font-medium rounded hover:bg-gray-300">
